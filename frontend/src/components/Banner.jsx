...
const Banner = () => {
  ...
  return (
    <div className='flex bg-primary rounded-lg px-6 py-6 sm:px-10 md:px-14 lg:px-12 my-20 md:mx-10'>

        <div className="flex-1 py- sm:py-10 md:py-16 lg:py-24 lg:pl-5">
