  ...
  return (
    <div>
      ...
      <div className="flex flex-col sm:flex-row items-start mt-5 gap-5">
        ...
        <div className="w-full grid grid-cols-auto gap-y-6 gap-4">
          {
            filterDoc.map((item, index) => (<div className='border border-blue-200 rounded-xl overflow-hidden cursor-pointer hover:translate-y-[-10px] transition-all duration-500' key={index} onClick={() => navigate(`/appointment/${item._id}`)}>
